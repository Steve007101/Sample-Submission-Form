...
$distributor_name, $distributor_phone, $distributor_email, $lab_cover_letter_dir, $template_path, $sample_recipient)  {
    ...
    array_push ($text1_arr, "");
    array_push ($text1_arr, "Enclosed, please find Company Sample ".$sample_num.".");
    array_push ($text1_arr, "");
    if ($lab_notes) {
    ...
    array_push ($text3_arr, "Please email reports to labreports@website.com as soon as they are available.");
    ...
    array_push ($text4_arr, "");
    array_push ($text4_arr, "Generic - Company");
